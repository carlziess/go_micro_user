...
type ProdReq struct {
	...
	//@inject_tag:uri:"pid"
	Pid int32 `protobuf:"varint,2,opt,name=Pid,proto3" json:"Pid,omitempty" uri:"pid"`
}
...
func (x *ProdDetailRsp) Reset() {
	*x = ProdDetailRsp{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ProdServices_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ProdDetailRsp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProdDetailRsp) ProtoMessage() {}

func (x *ProdDetailRsp) ProtoReflect() protoreflect.Message {
	mi := &file_ProdServices_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProdDetailRsp.ProtoReflect.Descriptor instead.
func (*ProdDetailRsp) Descriptor() ([]byte, []int) {
	return file_ProdServices_proto_rawDescGZIP(), []int{2}
}

func (x *ProdDetailRsp) GetData() *ProdModel {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_ProdServices_proto_rawDesc = []byte{
	...
	,
	...
	0x65, 0x71, 0x1a, 0x17, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x50, 0x72,
	0x6f, 0x64, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x52, 0x73, 0x70, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_ProdServices_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_ProdServices_proto_goTypes = []interface{}{
	(*ProdReq)(nil),       // 0: Services.ProdReq
	(*ProdRsp)(nil),       // 1: Services.ProdRsp
	(*ProdDetailRsp)(nil), // 2: Services.ProdDetailRsp
	(*ProdModel)(nil),     // 3: Services.ProdModel
}
var file_ProdServices_proto_depIdxs = []int32{
	3, // 0: Services.ProdRsp.Data:type_name -> Services.ProdModel
	3, // 1: Services.ProdDetailRsp.Data:type_name -> Services.ProdModel
	0, // 2: Services.ProdService.GetProdList:input_type -> Services.ProdReq
	0, // 3: Services.ProdService.GetProdDetail:input_type -> Services.ProdReq
	1, // 4: Services.ProdService.GetProdList:output_type -> Services.ProdRsp
	2, // 5: Services.ProdService.GetProdDetail:output_type -> Services.ProdDetailRsp
...
func file_ProdServices_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_ProdServices_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProdDetailRsp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
